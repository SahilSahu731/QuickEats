...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full">
      <form className="flex flex-col  bg-gray-100 shadow-xl gap-5 md:p-8 w-full max-w-md rounded-lg mx-4">
        ...
        </div>
        {
            loading ? (
                ...
                <Button onClick={forgotPasswordHandler} className="bg-orange hover:bg-hoverOrange">Send Reset Link</Button>
            )
        }
