...
const VerifyEmail = () => {
  ...
  const inputRef = useRef<any>([]);   //eslint-disable-line
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full">
      <div className="p-8 rounded-md w-full shadow-xl bg-gray-100 max-w-md flex flex-col gap-10 border border-gray-300">
