...
const SearchPage = () => {
  ...
  }, [params.text!, appliedFilter]);  //eslint-disable-line
      ...
      <div className="flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            <Input
              type="text"
              className="rounded-sm focus-visible:ring-transparent px-3 py-5"
              value={searchQuery}
            ...
            <Button
              ...
              className="bg-orange rounded-none py-3 px-8 transition-all duration-500 hover:px-12 hover:bg-hoverOrange"
            >
              Search
            </Button>
          </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              ...
              {appliedFilter.map(
                  (selectedFilter: string, idx: number) => (
                    ...
                    >
                      <Badge
                        className="text-blue-600 rounded-md hover:cursor-pointer pr-6 whitespace-nowrap"
                        variant="outline"
                      >
                        {selectedFilter}
                      </Badge>
                      <X
                        ...
                        size={16}
                        className="absolute text-blue-600 right-1 hover:cursor-pointer"
                      />
                    </div>
                  )
                )}
                      ...
                      <div className="flex gap-2 mt-4 flex-wrap">
                        {restaurant.cuisines.map(
                          (cuisine: string, idx: number) => (
                            <Badge
                              key={idx}
                              className="font-medium bg-blue-600 hover:bg-blue-800 px-2 py-1 rounded-full shadow-sm"
                            >
                              {cuisine}
                            </Badge>
                          )
